...
public class OverloadFun implements Function {
  public static final String ID = OverloadFun.class.getSimpleName();
  ...
  /**
   * Function to be executed in the server by YCSB
   */
  @Override
  ...
  private void executeHeavyMethod() {
    long duration = 100;
    double load = 1;
